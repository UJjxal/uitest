...
export default class BarChartMonMedRP extends Component {
  state={
  ...
  _renderChart(){
    bb.generate({
      ...
      axis: {
        x: {
          type: "category",
          // label:{text:"mg_L", position:"outer-center"}
        },
        y: {
          tick: function(val){
            return val + "%";
  ...
  render() {
    ...
    return (
    // <div id="wrapper">
    <div id="stackedBarChartIO1" style={{"height":"23rem", "width":"98%"}}></div>
    //</div>
    );
  }
}