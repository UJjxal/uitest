...
const AcquisitionsPerformance = () => {
    ...
    const getData = async () => {
        let url = `${CONTEXT}/cjo/acquisitions-performance.json`
        axios({
            method: "get",
            url: url,
            headers: {
            ...
            setFilterAnaysis({
                funnelAnalysis: result.data.AcquisitionsFunnel?.AllProducts,
    ...
    const changeAnalysisData = (e) => {
        switch (e) {
            case "allProducts":
                setFilterAnaysis({
                    funnelAnalysis: record.AcquisitionsFunnel?.AllProducts,
                    tableAnalysis: record.LTCRatioByChannel?.TableData.AllProducts
                })
                break;
            case "autoLoan":
                setFilterAnaysis({
                    funnelAnalysis: record.AcquisitionsFunnel?.AutoLoan,
                    tableAnalysis: record.LTCRatioByChannel?.TableData.AutoLoan
                })
                break;
            case "mortgage":
                setFilterAnaysis({
                    funnelAnalysis: record.AcquisitionsFunnel?.Mortgage,
                    tableAnalysis: record.LTCRatioByChannel?.TableData.Mortgage
                })
                break;
            case "creditCard":
                setFilterAnaysis({
                    funnelAnalysis: record.AcquisitionsFunnel?.CreditCard,
                    tableAnalysis: record.LTCRatioByChannel?.TableData.CreditCard,
                })
                break;
            case "personalLoan":
                setFilterAnaysis({
                    funnelAnalysis: record.AcquisitionsFunnel?.PersonalLoan,
                    tableAnalysis: record.LTCRatioByChannel?.TableData.PersonalLoan
                })
                break;
            case "ecl":
                setFilterAnaysis({
                    funnelAnalysis: record.AcquisitionsFunnel?.ECL,
...
export default AcquisitionsPerformance