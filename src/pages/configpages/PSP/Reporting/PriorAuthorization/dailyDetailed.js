    ...
    return(
        <div className="p-4">
          ...
          <div>
            ...
            <h5 className="text-center mb-1 py-2" style={{background: "#e6f7ff"}}>DETAILED REPORT</h5>
            <Table dataSource={data.dataSource.Input} columns={columnsInput} pagination={{ pageSize: 5}} bordered />
          </div>
          <div className="mb-5">
            <h5 className="text-center mb-1 py-2" style={{background: "#e6f7ff"}}>AUTHORIZATION STATUS</h5>
            <Table dataSource={data.dataSource.AuthorizationStatus} columns={columnsAuthorization} pagination={{ pageSize: 5}} bordered />
          </div>
          <div className="mb-5">
