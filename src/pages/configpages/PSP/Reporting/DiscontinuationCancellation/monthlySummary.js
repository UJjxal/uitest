...
const Summary = () => {
    ...
    console.log('Daily_Summary_monthly_Discontinuation', data.dataSource.Daily_Summary)
    return(
      <div className="p-4">
        <div className="mb-5">
        ...
        <div className="mb-5">
          ...
          <Table dataSource={data.dataSource.Monthly_Summary} columns={columnsMonthly} pagination={{ pageSize: 5}} bordered />
        </div>
    </div>
    )
}
