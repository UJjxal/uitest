    ...
    return(
        <div className="p-4">
          ...
          <div>
            ...
            <h5 className="text-center mb-1 py-2" style={{background: "#e6f7ff"}}>Patient Level Data</h5>
            <Table dataSource={data.dataSource.Patient_Level_Data} columns={columnsInput} pagination={{ pageSize: 5}} scroll={{ x: '150vw' }} bordered />
          </div>
        </div>
    )
}
