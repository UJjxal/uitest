...
import {
	MDBBtn,
	MDBCard, MDBCol,MDBIcon, MDBInput,
	MDBModal,
	MDBModalBody,
...
const RelativeProcedureCreateNew = (props) => {
    ...
    const ProcData = async () => {
		const result = await axios(`${CONTEXT}/Clinical/RWE/IntProcCreateNew.json`);
	...
	return (
		<MDBModal isOpen={props.primary2} toggle={() => setCancel()} className="cascading-modal mt-5" size="lg">
...
export default RelativeProcedureCreateNew;
