	...
	return (
		<MDBModal isOpen={props.relative} toggle={() => setCancel()} className="cascading-modal mt-5" size="fluid">
			<div className="modal-header primary-color white-text mb-0">
				<h4 className="title">
					<MDBIcon icon="dice-d6 fa-2x" /> Similar Studies Data
				</h4>
...
<tr>
<th style={{ textAlign:'center',verticalAlign:'middle',lineHeight:'normal' }}>Study ID</th>
<th style={{textAlign:'center',verticalAlign:'middle',lineHeight:'normal' }}>Title</th>
