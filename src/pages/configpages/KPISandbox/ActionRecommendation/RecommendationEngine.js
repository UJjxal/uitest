...
export default function RecommendationEngine(props){
    const createTypes=['Create Recommendation Manually', 'Model Generated Recommendations', 'Recommendations Moderation'];
